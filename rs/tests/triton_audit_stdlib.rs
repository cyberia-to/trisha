...
// crystal-domain: comp
// ---
/// Helper: write a temp program file in the trident repo root (so module
/// resolution finds `std/`, `vm/`, `os/`) and compile it.
///
/// Moved from trident's tests/audit_stdlib.rs — this suite asserts on
